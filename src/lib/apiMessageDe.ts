...
const EXACT: Record<string, string> = {
    ...
    'This list is not shared with you.': 'Diese Liste ist nicht mit dir geteilt.',
    'Only its owner can empty this list.': 'Nur wem die Liste gehört, kann sie leeren.',
    ...
    'Unshare with whom?': 'Mit wem nicht mehr teilen?',
