...
const EXACT: Record<string, string> = {
    ...
    'That passkey could not be checked.': 'Der Passkey konnte nicht geprüft werden.',
    ...
    'This list is not there.': 'Diese Liste gibt es nicht (mehr).',
    'Only whoever made this list can do that.': 'Das kann nur, wer die Liste angelegt hat.',
    'That is a lot of lists. Delete one first.': 'Das sind viele Listen. Lösch zuerst eine.',
    'The main list keeps its name.': 'Die Hauptliste behält ihren Namen.',
    'Delete which list?': 'Welche Liste löschen?',
    'The main list cannot be deleted. Empty it instead.': 'Die Hauptliste lässt sich nicht löschen, nur leeren.',
