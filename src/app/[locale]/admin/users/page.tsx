        ...
        <main className="container mx-auto max-w-3xl px-4 pb-32 md:px-8">
            <header className="flex flex-wrap items-baseline justify-between gap-4 border-b border-[var(--color-border)] pb-6 pt-12 sm:pt-16">
                ...
                <button
                    ...
                    className="text-sm underline underline-offset-4 hover:text-gray-500"
                >
                    {t('backToRecipes')}
                </button>
            </header>
            ...
            {loading ? (
                <p className="py-20 text-center text-gray-500">{t('loadingUsers')}</p>
            ) : users.length === 0 ? (
                <p className="py-20 text-center text-gray-500">{t('noUsers')}</p>
            ) : (
                        ...
                        >
                            ...
                            <span
                                className={`shrink-0 rounded-full px-2.5 py-0.5 text-xs font-medium uppercase tracking-widest ${user.admin
                                    ...
                                    : 'border border-[var(--color-border)] text-gray-500'
                                    }`}
                            >
