 ...
 * Your own account.
 *
 * One thing on it today — the picture beside your name — and that is the right
 * size for it. A settings page invented before there are settings collects
 * empty sections; this one grows when something needs to live here.
 *
...
export default async function AccountPage({
    ...
    const me: { name: string; email: string; avatarUrl: string | null } | null =
