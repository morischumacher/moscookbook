...
| `/[locale]/s/[token]` | open | steps aside | `* /api/shopping`<br>`* /api/shopping/members`<br>`* /api/shopping/share`<br>`* /api/shopping/shared/[id]`<br>`DELETE /api/shopping/[id]`<br>`DELETE /api/shopping/members`<br>`GET /api/shopping`<br>`GET /api/shopping/members`<br>`PATCH /api/shopping/[id]`<br>`PATCH /api/shopping/share` | `/[locale]`<br>`/[locale]/shopping` |
| `/[locale]/share` | account | requires session | `POST /api/capture/share` | `/[locale]/admin/inbox` |
| `/[locale]/shopping` | account | requires session | `* /api/shopping`<br>`* /api/shopping/members`<br>`* /api/shopping/share`<br>`* /api/shopping/shared/[id]`<br>`DELETE /api/shopping/[id]`<br>`DELETE /api/shopping/members`<br>`GET /api/shopping`<br>`GET /api/shopping/members`<br>`PATCH /api/shopping/[id]`<br>`PATCH /api/shopping/share` | `/[locale]`<br>`/[locale]/login`<br>`/[locale]/shopping` |
...
- `* /api/shopping/members  (from shopping/ShoppingSharing)`
...
- `GET /api/shopping  (from shopping/ShoppingListView)`
